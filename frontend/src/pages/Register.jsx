...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-6 relative overflow-hidden selection:bg-accent selection:text-white">
      {/* Background elements */}
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-accent/5 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      >
        ...
        <h2 className="text-[28px] font-display font-bold text-white text-center mb-2">Create Account</h2>
        <p className="text-text-secondary text-center mb-8 text-[14px]">Join the platform to access clinical-grade AI tools.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1.5">
            <label className="text-[12px] font-body font-bold uppercase tracking-wider text-text-muted">Full Name</label>
          ...
          <div className="space-y-1.5">
            <label className="text-[12px] font-body font-bold uppercase tracking-wider text-text-muted">Email Address</label>
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-[#555] group-focus-within:text-accent transition-colors">
                <Mail size={16} />
              </div>
        ...
        <p className="mt-8 text-center text-[13px] text-text-secondary">
          ...
          <Link to="/login" className="text-white hover:text-accent border-b border-transparent hover:border-accent transition-colors font-medium">
            Sign In
          </Link>
        </p>
      </motion.div>
